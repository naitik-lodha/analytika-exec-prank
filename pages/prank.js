  ...
  return (
    <div className="flex flex-col justify-center p-4 items-center h-screen bg-black">
      ...
      <div className="text-white text-center mb-6">
        <p className="text-3xl font-bold  bg-gradient-to-r from-yellow-300 via-green-500 to-green-700 inline-block bg-clip-text text-transparent">
          Congratulations,{" "}
          <span className="text-3xl font-extrabold">{name} !</span>
        </p>
        <br />
        <p className="text-xl inline-block mt-2">
